                         ...
                         <div class="table-responsive">
                             <div class="table-wrapper">
                                 <div class="table-title">
                                     <div class="row">
                                         <div class="col-sm-8"><h2>Sales <b>Details</b></h2></div>
                                         <div class="col-sm-4">
                                     ...
                                     <tbody>
                                         ...
                                         @foreach($orders as $order)
                                            <tr>
                                                ...
                                                <td><p data-placement="top" data-toggle="tooltip" title="view"><button class="btn btn-primary btn-xs" data-title="view" data-toggle="modal" data-target="#view"><span class="glyphicon glyphicon-pencil"><a href={{ 'viewprescription'.$order['id'] }} style="text-decoration: none;     color: white; ">View </a></span></button></p></td>

                                                <td><p data-placement="top" data-toggle="tooltip" title="view"><button class="btn btn-success btn-xs" data-title="view" data-toggle="modal" data-target="#view"><span class="glyphicon glyphicon-pencil"><a href={{ 'vieworder'.$order['id'] }} style="text-decoration: none;     color: white; ">View </a></span></button></p></td>
